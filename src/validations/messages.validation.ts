...
export const validationLengthMessage = makeValidationOpts('The $property length must be between $constraint1 and constraint2 characters');
export const validationLengthMinMessage = makeValidationOpts('The $property must be at least $constraint1 characters');
